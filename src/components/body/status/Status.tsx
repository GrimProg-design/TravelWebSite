      ...
      <div className="status-card-glass">
        ...
        <div className="info-grid">
          ...
          <div className="info-item">
            ...
            <p className="info-value">
              ...
              {t("status_mock_participants_suffix")}
            </p>
          </div>
        ...
        <div className="progress-section">
          <span className="progress-label">
            {t("status_label_time_remaining")}
          </span>
          <SparklingProgressBar progress={bookingDetails.timeRemaining} />
          <p className="progress-text">
            {t("status_progress_text_part1")}{" "}
            {100 - bookingDetails.timeRemaining}%{" "}
            {t("status_progress_text_part2")}
          </p>
        </div>
